  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 animate-fade-in">
      <div className="flex items-center gap-3">
        <Skeleton className="h-8 w-8 rounded-xl shimmer" />
      ...
      <Card className="border-0 shadow-sm shadow-foreground/[0.03] border-r-[3px] border-r-warm-amber/20 rounded-2xl">
        ...
        <CardContent className="space-y-4">
          ...
          <Skeleton className="h-8 w-28 rounded-xl shimmer" />
        </CardContent>
      </Card>
      ...
      <Card className="border-0 shadow-sm shadow-foreground/[0.03] rounded-2xl">
        ...
        <CardContent>
          <div className="rounded-xl ring-1 ring-border/40 p-10 flex flex-col items-center gap-3">
            <Skeleton className="h-12 w-12 rounded-2xl shimmer" />
            <Skeleton className="h-4 w-28 shimmer" />
            <Skeleton className="h-3.5 w-44 shimmer" />
          </div>
        </CardContent>
      </Card>
    </div>
