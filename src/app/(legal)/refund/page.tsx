  ...
  return (
    <article className="prose prose-neutral max-w-none space-y-8 text-foreground">
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-foreground/85">
          השירות מציע תוכנית חינמית המאפשרת שימוש מוגבל (עד 5 קבלות בחודש, פרויקט אחד) ללא כל עלות וללא הגבלת זמן. אנו ממליצים לנצל את התוכנית החינמית כדי להכיר את השירות לפני שדרוג לתוכנית בתשלום.
        </p>
      </section>
